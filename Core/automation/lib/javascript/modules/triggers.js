...
*/
exports.StartupTrigger = function(triggerName){
...
exports.ChannelEventTrigger = function(channel, event, triggerName) {
...
// ### ChangedEventTrigger ###
exports.ItemStateChangeTrigger = function(itemName, oldState, newState, triggerName){
...
exports.ChangedEventTrigger = exports.ItemStateChangeTrigger; 


// ### UpdatedEventTrigger ###
exports.ItemStateUpdateTrigger = function(itemName, state, triggerName){
...
exports.UpdatedEventTrigger = exports.ItemStateUpdateTrigger; 


// ### CommandEventTrigger ###
exports.ItemCommandTrigger = function(itemName, command, triggerName){
...
exports.CommandEventTrigger = exports.ItemCommandTrigger; 

// ### TimerTrigger ###
//!!!!!!!! timer.GenericCronTrigger !!!!!!!!!!!!!
exports.GenericCronTrigger = function(expression, triggerName){
...
exports.TimerTrigger = exports.GenericCronTrigger; 
...
var getTrName = function(trn){
    //TODO: replacement for 'me'
	return trn == undefined || trn == null || trn == "" ? utils.uuid.randomUUID() : trn;
