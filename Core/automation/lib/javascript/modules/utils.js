...
//TODO: migrate to CommonJS
load( mainPath + '/PersistenceExtensions.js');

  try {
	context.RuleBuilder = Java.type("org.openhab.core.automation.util.RuleBuilder");
  } catch(e) {
	context.RuleBuilder = Java.type("org.eclipse.smarthome.automation.core.util.RuleBuilder");
  }
  
  try {
	context.RuleManager = Java.type("org.openhab.core.automation.RuleManager");
  } catch(e) {
	context.RuleManager = Java.type("org.eclipse.smarthome.automation.RuleManager");
  }

  context.uuid 					= Java.type("java.util.UUID");
  context.ScriptExecution 		= Java.type("org.eclipse.smarthome.model.script.actions.ScriptExecution");
  context.ScriptServiceUtil 		= Java.type("org.eclipse.smarthome.model.script.ScriptServiceUtil");
  context.ExecUtil 				= Java.type("org.eclipse.smarthome.io.net.exec.ExecUtil");
  context.HttpUtil 				= Java.type("org.eclipse.smarthome.io.net.http.HttpUtil");


  //Other
  context.Modifier 				= Java.type("java.lang.reflect.Modifier");
  context.InputStream				= Java.type("java.io.InputStream");
  context.IOUtils					= Java.type("org.apache.commons.io.IOUtils");
  ...
  */
  ...
  //Time JAVA 7 joda
  context.DateTime 				= Java.type("org.joda.time.DateTime");
  //Time JAVA 8
  context.LocalDate 				= Java.type("java.time.LocalDate");
  context.LocalDateTime 			= Java.type("java.time.LocalDateTime");
  context.FormatStyle 			= Java.type("java.time.format.FormatStyle");
  context.DateTimeFormatter 		= Java.type("java.time.format.DateTimeFormatter");//https://www.programcreek.com/java-api-examples/?class=java.time.format.DateTimeFormatter&method=ofLocalizedDateTime
  context.LocalTime 				= Java.type("java.time.LocalTime");
  context.Month 					= Java.type("java.time.Month");
  context.ZoneOffset 				= Java.type("java.time.ZoneOffset");
  context.ZoneId 					= Java.type("java.time.ZoneId");
  context.OffsetDateTime 			= Java.type("java.time.OffsetDateTime");

  context.Timer = Java.type('java.util.Timer');
