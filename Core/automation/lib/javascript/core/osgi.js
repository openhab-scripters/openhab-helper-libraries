...
(function(context) {
    ...
    var bundle_context = (typeof _bundle !== null) ? _bundle.getBundleContext() : null;
    var registered_services = [];

    context.get_service = function(class_or_name) {
        if (typeof bundle_context !== null) {
            ...
            return (typeof ref !== null) ? bundle_context.getService(ref) : null;
        }
    }
