...
.. code-block::
    ...
    @when("System started")# requires S1566 or newer, and 'System shuts down' is not available
    @when("Item added")
    @when("Directory contents added")
    @when("Subdirectory contents modified")
...
#log.warn("dir()=[{}]".format(dir()))
#log.warn("scope=[{}]".format(dir(scope)))
