...
JSRule({
	...
	execute: function( module, input){
		...
		sendCommand("Color_Item", new HSBType(getRandom360() + "," + getRandom100() + "," + getRandom100()));//as String
        ...
        var Color_Item = itemRegistry.getItem("Color_Item");
