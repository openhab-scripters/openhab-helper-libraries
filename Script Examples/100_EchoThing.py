...
import openhab
from openhab.osgi import register_service, unregister_service, get_service
...
log = openhab.log.logging.getLogger("{}.{}".format(BINDING_ID, THING_NAME))
...
openhab.JythonThingTypeProvider.add(
    ThingType(
...
openhab.JythonBindingInfoProvider.add(
    BindingInfo(
