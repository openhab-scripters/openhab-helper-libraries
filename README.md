...
N/A | event.memberName | "changed" (only for a Group) | [GroupItemStateChangedEvent](https://github.com/eclipse/smarthome/blob/master/bundles/core/org.eclipse.smarthome.core/src/main/java/org/eclipse/smarthome/core/items/events/GroupItemStateChangedEvent.java) | Name of member that caused the Group state change (String)
